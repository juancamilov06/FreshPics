...
class SearchRepositoryTest {
    ...
    fun `When getTrending is called, remote data source should be called`() = runBlockingTest {
        ...
        whenever(
            searchRemoteDataSource.getGifsByName(
                name = "",
                offset = TEST_OFFSET,
                rating = TEST_RATING,
                limit = TEST_LIMIT
        ...
        verify(searchRemoteDataSource).getGifsByName(
            name = "",
            offset = TEST_OFFSET,
            rating = TEST_RATING,
            limit = TEST_LIMIT
    ...
    fun `Given getTrending is called, when getTrendingGifs is success, result should be success`() = runBlockingTest {
        ...
        val repository = buildRepository()
        val result = repository.searchByName(
            name = "",
            offset = TEST_OFFSET,
            rating = TEST_RATING,
            limit = TEST_LIMIT
    ...
    private fun buildRepository() = SearchRepositoryImpl(
